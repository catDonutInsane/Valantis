...
const reducer = createSlice({
    ...
    reducers:{
        ...
        getFullInfoList(state, action:PayloadAction<Item[]>){
            state.fullInfoList = action.payload.reduce((accumulator:any, current:any) => {
...
export const {setParams,setparamsToGetTotalCount,setPagDisable,
                setItemList,getFullInfoList,setIsLoading,
                setTotalCount} = reducer.actions
